  ...
  const analyzeMessage = async () => {
    ...
    try {
      ...
      const genAI = new GoogleGenerativeAI(
        "AIzaSyDL1M9tpuXbMVP3c5gl3Olj4IjQHRCYnOc"
      );
      ...
      console.log(
        "Raw analysisResult from direct Gemini call:",
        analysisResult
      );
      ...
      try {
        ...
        if (!content)
          throw new Error(
            "AI response content is empty or undefined, cannot parse."
          );
        ...
        setError(
          "Failed to parse AI response. The AI might not have returned valid JSON. Check console for raw response and parsing details."
        );
      }
    } catch (err) {
      setError(
        "Error analyzing message. Please check your API key, model access, network connection, or if the message violates safety policies."
      );
      ...
      if (err.response?.data?.error) {
        ...
        setError(
          (prev) =>
            prev +
            ` Details: ${
              err.response.data.error.message || err.response.data.error.status
            }`
        );
      }
    } finally {
    ...
    <div style={styles.container}>
      <div style={styles.contentArea}>
        ...
        <p style={styles.appDescription}>
          Analyze messages for potential spam and danger.
        </p>
        <div
          style={{
            marginBottom: "2rem",
        ...
        >
          <h3 style={styles.sectionTitle}>Analyze Message</h3>
            ...
            <div style={styles.resultContainer}>
              <div style={styles.scoreGrid}>
                <div style={styles.scoreCard}>
                  <h3
                    style={{ ...styles.scoreTitle, ...styles.spamScoreTitle }}
                  >
                    Spam Score
                  </h3>
                  <div
                    style={{ ...styles.scoreValue, ...styles.spamScoreValue }}
                  >
                ...
                <div style={styles.scoreCard}>
                  <h3
                    style={{ ...styles.scoreTitle, ...styles.dangerScoreTitle }}
                  >
                    Danger Score
                  </h3>
                  <div
                    style={{ ...styles.scoreValue, ...styles.dangerScoreValue }}
                  >
                  ...
                  <ul style={styles.warningsList}>
                    {parsedResult.warnings?.length > 0 ? (
                      ...
                      <li style={styles.warningItem}>
                        No specific warnings detected based on text analysis.
                      </li>
                    )}
                  </ul>
                </div>
