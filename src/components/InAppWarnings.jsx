...
const styles = {
  ...
  scoreCard: {
    backgroundColor: 'rgba(255, 255, 255, 0.7)', // Lighter transparent white
    borderRadius: '15px',
    padding: '1rem',
    textAlign: 'center',
    boxShadow: '0 3px 10px rgba(0,0,0,0.05)',
    border: '1px solid #9370DB', // Purple border
  },
  scoreTitle: {
    fontSize: '1rem',
    fontWeight: '500',
    marginBottom: '0.5rem',
    color: '#501773', // Purple shade
  },
  spamScoreTitle: { color: '#8A2BE2' }, // Blue Violet
  dangerScoreTitle: { color: '#8B008B' }, // Dark Magenta
  scoreValue: {
    fontSize: '1.875rem',
    fontWeight: '700',
  },
...
// Inject CSS into the document head for global styles and keyframes
...
const genAI = new GoogleGenerativeAI("AIzaSyDL1M9tpuXbMVP3c5gl3Olj4IjQHRCYnOc");
      ...
      try {
        ...
        console.log("Derived 'content' for parsing:", content);

        if (!content) {
          throw new Error("AI response content is empty or undefined, cannot parse.");
        }
        ...
        console.log("String attempting to JSON.parse:", jsonStr);
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <div style={styles.inputContainer}>
            <textarea
              ...
              // You can add a separate state for link if needed, or modify 'message'
              value={message}
              onChange={handleMessageChange}
              rows={2} // Smaller rows for link input
            />
          </div>
            ...
            <div style={styles.resultContainer}>
              <div style={styles.scoreGrid}>
                <div style={styles.scoreCard}>
                  <h3 style={{ ...styles.scoreTitle, ...styles.spamScoreTitle }}>
                    Spam Score
                  </h3>
                  <div
                    style={{
                      ...styles.scoreValue,
                      ...styles.spamScoreValue,
                    }}
                  >
